...
sample_assessments_inbo <- sample_admin_inbo %>%
    ...
    select(sample_id, type_target, location_id, sac, grts_ranking, year_planned, assessment_status, assessment_year, measured, completed, location_change, is_type_target, type_observed,  allow_other_type, type_cover_circle, type_cover_square, x_measured, y_measured, distance_from_sample)
...
mhq_assessments_summary <- sample_assessments_update %>%
    filter(!is.na(assessment_status) & assessment_status != "no assessment") %>%
    select(sample_id, grts_ranking, assessment_status, type_target, is_type_target, type_observed, location_change, distance_from_sample, x_measured, y_measured)
