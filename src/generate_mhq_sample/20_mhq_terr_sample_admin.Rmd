...
- We assume that the reference point is located in the type observed in the square plot that corresponds to (one of) the target type(s). 
...
We apply these rules and check of we select one type for each reference point this way.
