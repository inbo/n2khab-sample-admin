...
write_vc(mhq_terr_samples, file = "mhq_terr_refpoints", root = "../../data", sorting = c("type", "sampling_unit_code"), strict = FALSE, optimize = FALSE)

write_vc(mhq_terr_samples_details, file = "mhq_terr_refpoints_details", root = "../../data", sorting = c("type", "sampling_unit_code"), strict = FALSE, optimize = FALSE)
