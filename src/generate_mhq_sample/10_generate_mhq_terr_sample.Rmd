...
The sampling units for the monitoring habitat quality (mhq) programme [Westra et al., 2014](https://pureportal.inbo.be/portal/files/4339795/Westra_etal_2014_MonitoringNatura2000Habitats.pdf) were drawn based on the grts-method. The mhq sampling units were stored in different files. Here we will generate one standardized table containing all mhq sampling units including legacy sites. Legacy sites are existing sampling units that were included in mhq.
