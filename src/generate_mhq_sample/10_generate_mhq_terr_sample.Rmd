...
mhq_terr_samples <- mhq_terr_samples_details %>%
    select(scheme, sampling_unit_code, point_code, type, sac, grts_ranking, is_centroid, grts_ranking_draw,  legacy_site, x, y, db_ref, year_planned)
...
write_vc(mhq_terr_details_samplingframe, file = "mhq_terr_details_samplingframe", root = "../../data", sorting = c("type", "sampling_unit_code"), strict = FALSE, optimize = FALSE)
