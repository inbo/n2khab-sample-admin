...
sampleframe_sf <- read_sf("../../n2khab_mhq_data/10_raw/sample/sampleframe", "BWK_hab_ter_SBZH_versie20140324", crs = 31370) %>%
    select(Pol_ID)

sampleframe_types_orig <- read.table("../../n2khab_mhq_data/10_raw/sample/sampleframe/BWK_habsubt_versie20140324.txt", stringsAsFactors = FALSE)
...
sample_6510_orig <- read_sf("../../n2khab_mhq_data/10_raw/sample/sample-locations/6510_hab", "steekproef_6510_versie20140506", crs =31370, quiet = TRUE) 
...
sample_heath_orig <- read_sf("../../n2khab_mhq_data/10_raw/sample/sample-locations/heide_hab", "meetnet_heide_versie201400611", crs =31370, quiet = TRUE) 
...
sample_forest_orig <- read_sf("../../n2khab_mhq_data/10_raw/sample/sample-locations/bos_hab", "meetnet_bos_versie20150303", crs =31370, quiet = TRUE) 
...
sample_grassland_marshes_orig <- read_sf("../../n2khab_mhq_data/10_raw/sample/sample-locations/grasland-moeras_hab", "meetnet_graslandEnCo_versie20150303", crs =31370, quiet = TRUE) 
...
sample_dunes_orig <- read.csv2("../../n2khab_mhq_data/10_raw/sample/sample-locations/kustduinen_hab/steekproef_duinen_tabel_versie2018-11-2018.csv",
...
```{r}
sample_91E0_sf_orig <- read_sf("../../n2khab_mhq_data/10_raw/sample/sample-locations/91E0_sf_hab", "PQ_91E0_sf_MONEOS_versie2018-04-16", crs =31370, quiet = TRUE) 
...
grts_master <- read_GRTSmh(file = "10_raw/GRTSmaster_habitats/GRTSmaster_habitats.tif")

### VBI-plots die opgemeten werden in 2de cyclus

dbVBIMeetproces <- "../../n2khab_mhq_data/10_raw/sample/sample-locations/bos_hab_vbi/VBI_Meetproces_v2019-02-20.accdb"
...
```{r}
sample_1330_da_orig <- read.csv2("../../n2khab_mhq_data/10_raw/sample/sample-locations/1330_da_hab/Structuurgegevens_1330_da.csv", stringsAsFactors = FALSE)
...
write.csv2(samples, "../../output/mhq_terr_samples.csv", row.names = FALSE)
