...
mhq_refpoints_new_inbo <- mhq_refpoints_todo_potential %>%
  ...
  select(sampling_unit_code, point_code, sac, type_target, phab, n_type_target, type_target_all, grts_ranking_draw, ranking_rel, x = x_coord, y = y_coord, polygon_id, description_orig, replacement_rule) %>%
